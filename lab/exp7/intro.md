...
> Creating the admin user `Riya Jain` during Jenkins initial configuration.


---

### Screenshot 4 — Ngrok setup for Authtoken
...
### Screenshot 5 — Jenkins Setup Done
![Jenkins Agent Command]![alt text](image-4.png)
